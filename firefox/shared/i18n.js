...
export const I18N = {
  en: {
    ...
    clearReciter: "Clear",
    clearSurah: "Clear",
    clearSurahButton: "Clear surah",
    clearReciterButton: "Clear reciter",
    ...
    playingBannerLabel: "Stop playing: {surah} · {reciter}",
    statusPlaying: "Playing...",
    statusReciterUnavailable: "Reciter not available right now.",
  ...
  fr: {
    ...
    clearSurah: "Effacer",
    clearSurahButton: "Effacer la sourate",
    clearReciterButton: "Effacer le récitateur",
    ...
    playingBannerLabel: "Arrêter la lecture : {surah} · {reciter}",
    statusPlaying: "Lecture en cours...",
    statusReciterUnavailable: "Récitateur indisponible pour le moment.",
  ...
  ar: {
    ...
    clearReciter: "مسح",
    clearSurah: "مسح",
    clearSurahButton: "مسح السورة",
    clearReciterButton: "مسح القارئ",
    errorNetwork: "خطأ في الاتصال. يرجى التحقق من الإنترنت.",
    errorFormat: "تنسيق الصوت غير مدعوم في المتصفح.",
    errorAutoplay: "انقر زر التشغيل لبدء الصوت (سياسة المتصفح).",
    errorTimeout: "انتهت مهلة تحميل الصوت. يرجى المحاولة مرة أخرى.",
    errorNotFound: "الصوت غير متوفر لهذا القارئ أو هذه السورة.",
    errorGeneral: "تعذر تشغيل الصوت حالياً. يرجى المحاولة مرة أخرى.",
    errorLoadingData: "فشل تحميل المحتوى",
    errorOffline: "لا يوجد اتصال بالإنترنت",
    loadingContent: "جارٍ التحميل",
    loadingComplete: "تم تحميل المحتوى",
    loadingAudio: "جارٍ تحميل الصوت",
    resumingFrom: "استئناف من",
    resuming: "جارٍ الاستئناف",
    pausedAt: "متوقف عند",
    paused: "متوقف",
    resumeFailed: "فشل استئناف الصوت",
    audioConnectionLost: "انقطع اتصال الصوت. أعد التحميل إذا توقف التشغيل.",
    searchSura: "ابحث عن سورة بالاسم أو الرقم",
    continueAffordance: "متابعة {name} من {time}",
    stopPlaying: "إيقاف التشغيل",
    playingBannerLabel: "إيقاف التشغيل: {surah} · {reciter}",
    statusPlaying: "جارٍ التشغيل...",
    statusReciterUnavailable: "القارئ غير متاح حالياً.",
